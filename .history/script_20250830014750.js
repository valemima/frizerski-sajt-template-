...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.dugme-akcija').forEach(dugme => {
        dugme.addEventListener('click', function(event) {
            ...
            if (popustTip) {
                ...
                // DODAJ OVO: Obriši generički popust ako postoji
    ...
    function prikaziPopustNotifikaciju(popustTip) {
        ...
        switch(popustTip) {
            case 'studentski':
                poruka = '🎓 Studentski popust od 20% je aktiviran! Prikazaće se na Calendlyju.';
                break;
            case 'dame':
                poruka = '💅 Paket za dame sa popustom je aktiviran! Prikazaće se na Calendlyju.';
                break;
            case 'prijatelj':
                poruka = '👥 Popust "Dovedi prijatelja" od 15% je aktiviran! Prikazaće se na Calendlyju.';
                break;
            default:
